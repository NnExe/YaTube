# Generated by Django 2.2.9 on 2022-04-18 18:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='group',
            name='slug',
            field=models.SlugField(unique=True, verbose_name='slug-код группы'),
        ),
        migrations.AlterField(
            model_name='group',
            name='title',
        ...
        migrations.AlterField(
            model_name='post',
            name='group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='posts.Group', verbose_name='Група поста'),
        ),
        migrations.AlterField(
            model_name='post',
            name='pub_date',
